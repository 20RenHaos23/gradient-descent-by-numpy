...
optimizator_Basic = Opt_Basic([x0],0.000005)
path_Basic = gradient_descent_(df,optimizator_Basic,300000)
print("gradient_descent_basic",path_Basic[-1])

optimizator_Momentum = Opt_Momentum([x0],0.000005,0.8)
path_Momentum = gradient_descent_(df,optimizator_Momentum,300000)
print("gradient_descent_momentum",path_Momentum[-1])

optimizator_Adagrad = Opt_Adagrad([x0],0.1,1e-8)
path_Adagrad = gradient_descent_(df,optimizator_Adagrad,300000)
print("gradient_descent_adagrad",path_Adagrad[-1])

optimizator_Adadelta = Opt_Adadelta([x0],0.95,1e-8,)
path_Adadelta = gradient_descent_(df,optimizator_Adadelta,300000)
print("gradient_descent_adadelta",path_Adadelta[-1])

optimizator_RMSprop = Opt_RMSprop([x0],0.000005,0.99999999999,1e-8)
path_RMSprop = gradient_descent_(df,optimizator_RMSprop,900000)
print("gradient_descent_rmsprop",path_RMSprop[-1])

optimizator_Adam = Opt_Adam([x0],0.001,0.9,0.8,1e-8)
path_Adam = gradient_descent_(df,optimizator_Adam,100000)
