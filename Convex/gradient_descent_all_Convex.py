...
path_momentum = gradient_descent_momentum(df,x0,0.1,0.8,100)
print("gradient_descent_momentum",path_momentum[-1])

path_Adagrad = gradient_descent_Adagrad(df,x0,0.1,100,1e-8)
print("gradient_descent_Adagrad",path_Adagrad[-1])

path_Adadelta = gradient_descent_Adadelta(df,x0,0.95,100,1e-8)
print("gradient_descent_Adadelta",path_Adadelta[-1])

path_RMSprop = gradient_descent_RMSprop(df,x0,0.05,0.9,100,1e-8)
print("gradient_descent_RMSprop",path_RMSprop[-1])

path_Adam = gradient_descent_Adam(df,x0,0.1,0.7,0.9,100,1e-8)
